...
with open("screened/nonphos_inter_"+sys.argv[1]+".txt") as base_phos:
    for line in base_phos:
    	inter_raw.append(line)

with open("screened/nonphos_screened_"+sys.argv[1]+".txt") as base_nonphos:
    for line in base_nonphos:
        screen_raw.append(line)

################################################################

sel_file = open("screened/nonphos_residual_"+sys.argv[1]+".txt", 'w')
sel_list = []
sel_cut = 0.0
